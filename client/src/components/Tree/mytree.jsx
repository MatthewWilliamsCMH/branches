    ...
    if (!loading && !error && data) {
      ...
      treeRef.current.onUpdateNode(async (args) => {
        ...
        const updatedPersonData = {
          id: args.node.id,
          firstName: args.node.name.split(" ")[0], // Assuming firstName is first part of name
          lastName: args.node.name.split(" ")[1], // Assuming lastName is second part of name
          gender: args.node.gender, // Example of gender update
          img: args.node.img || "", // Update image if changed
